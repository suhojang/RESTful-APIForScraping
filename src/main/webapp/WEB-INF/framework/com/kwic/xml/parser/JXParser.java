 ...
 * @throws JaxenException 
  ...
  */
  ...
  /**
   * std를 기준으로 compare에 동일 compareAttributeName를 가지는 element가 있다면 std의 element 속성값을 compare의 element의 속성값으로 replace하고
   * 없다면 std의 element를 제거한다. 
 * @throws JaxenException 
   * */
  public static void fixedBy(JXParser std, JXParser compare,String compareAttributeName,String[] expElementTag) throws JaxenException{
	  fixedBy(std,std.getRootElement(), compare,compareAttributeName,expElementTag);
  }
  @SuppressWarnings("unchecked")
  public static void fixedBy(JXParser stdJxp,Element std,JXParser compareJxp,String compareAttributeName,String[] expElementTag) throws JaxenException{
	  boolean isExceptable	= false;
	  for(int i=0;i<expElementTag.length;i++){
		  if(expElementTag[i].equals(std.getName())){
			  isExceptable	= true;
			  break;
		  }
	  }
	  String attrVal	= isExceptable?null:stdJxp.getAttribute(std,compareAttributeName);
	  attrVal			= "".equals(attrVal)?null:attrVal;
	  Element tgt		= null;
	  Element[] childs	= null;

	  if(attrVal!=null)
		  tgt	= compareJxp.getElement("//*[@"+compareAttributeName+"='"+attrVal+"']");
	  if(attrVal!=null && tgt!=null){
		  List<Attribute> attrs	= std.attributes();
		  for(int i=attrs.size()-1;i>=0;i--)
			  std.remove(attrs.get(i));
		  attrs	= tgt.attributes();
		  for(int i=0;i<attrs.size();i++)
			  stdJxp.setAttribute(std,attrs.get(i).getName(),compareJxp.getAttribute(tgt, attrs.get(i).getName()));
		  childs	= stdJxp.getChilds(std);
		  for(int i=0;i<childs.length;i++){
			  fixedBy(stdJxp,childs[i],compareJxp,compareAttributeName,expElementTag);
		  }
		  ...
		  if(!StringUtil.isContain(expElementTag,std.getName()))
			  stdJxp.removeElement(std);
	  }
  }
  
  public static void main(String[] args) throws Exception{
	  JXParser jxp1	= new JXParser("<?xml version='1.0' encoding='utf-8'?><root><tree name=\"메뉴관리\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-1\"><MENU id=\"STS\" uri=\"/STS_ACB_010000\" use=\"Y\" name=\"통계\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-2\"><MENU id=\"STS_ACB_010000\" uri=\"/STS_ACB_010000\" use=\"Y\" name=\"계좌잔액현황\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-3\"/><MENU id=\"STS_INC_010000\" uri=\"/STS_INC_010000\" use=\"Y\" name=\"수입현황\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-4\"/><MENU id=\"STS_IVS_010000\" uri=\"/STS_IVS_010000\" use=\"Y\" name=\"투자대금현황\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-5\"/><MENU id=\"STS_SLC_010000\" uri=\"/STS_SLC_010000\" use=\"Y\" name=\"판매자금일일결산\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-6\"/><MENU id=\"STS_FCI_010000\" uri=\"/STS_FCI_010000\" use=\"Y\" name=\"시설별수입현황\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-7\"/><MENU id=\"STS_RMS_010000\" uri=\"/STS_RMS_010000\" use=\"Y\" name=\"송금결산현황\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-8\"/><MENU id=\"STS_WRS_010000\" uri=\"/STS_WRS_010000\" use=\"Y\" name=\"송금결산현황(총괄)\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-9\"/><MENU id=\"STS_DCC_010000\" uri=\"/STS_DCC_010000\" use=\"Y\" name=\"자금일일결산\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-10\"/></MENU><MENU id=\"MRT\" uri=\"/MRT_SLS_010000\" use=\"Y\" name=\"마트\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-11\"><MENU id=\"MRT_SLS_010000\" uri=\"/MRT_SLS_010000\" use=\"Y\" name=\"판매통계\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-12\"/><MENU id=\"MRT_MSS_010000\" uri=\"/MRT_MSS_010000\" use=\"Y\" name=\"현금매출통계\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-13\"/><MENU id=\"MRT_MHB_010000\" uri=\"/MRT_MHB_010000\" use=\"Y\" name=\"현금거래내역\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-14\"/><MENU id=\"MRT_MMC_010000\" uri=\"/MRT_MMC_010000\" use=\"Y\" name=\"현금매출월마감리스트\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-15\"/><MENU id=\"MRT_CDI_010000\" uri=\"/MRT_CDI_010000\" use=\"Y\" name=\"카드입금내역\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-16\"/><MENU id=\"MRT_PCD_010000\" uri=\"/MRT_PCD_010000\" use=\"Y\" name=\"모계좌입금내역\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-17\"/><MENU id=\"MRT_OVD_010000\" uri=\"/MRT_OVD_010000\" use=\"Y\" name=\"착오입금\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-18\"/><MENU id=\"MRT_PDA_010000\" uri=\"/MRT_PDA_010000\" use=\"Y\" name=\"POS일일결산\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-19\"/><MENU id=\"MRT_CDD_010000\" uri=\"/MRT_CDD_010000\" use=\"Y\" name=\"카드사매입\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-20\"/><MENU id=\"MRT_DLD_010000\" uri=\"/MRT_DLD_010000\" use=\"Y\" name=\"입금일매입\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-21\"/><MENU id=\"MRT_RND_010000\" uri=\"/MRT_RND_010000\" use=\"Y\" name=\"반송/미매입\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-22\"/></MENU></tree></root>");
	  JXParser jxp2	= new JXParser("<?xml version='1.0' encoding='utf-8'?><root><tree name=\"111111메뉴관리\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-1\"><MENU id=\"MRT\" uri=\"/MRT_SLS_010001\" use=\"A\" name=\"111111마트\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-11\"><MENU id=\"MRT_MSS_010001\" uri=\"/MRT_MSS_010001\" use=\"A\" name=\"111111현금매출통계\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-13\"/><MENU id=\"MRT_MHB_010001\" uri=\"/MRT_MHB_010001\" use=\"A\" name=\"111111현금거래내역\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-14\"/><MENU id=\"MRT_MMC_010001\" uri=\"/MRT_MMC_010001\" use=\"A\" name=\"111111현금매출월마감리스트\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-15\"/><MENU id=\"MRT_CDI_010001\" uri=\"/MRT_CDI_010001\" use=\"A\" name=\"111111카드입금내역\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-16\"/><MENU id=\"MRT_PCD_010001\" uri=\"/MRT_PCD_010001\" use=\"A\" name=\"111111모계좌입금내역\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-17\"/><MENU id=\"MRT_OVD_010001\" uri=\"/MRT_OVD_010001\" use=\"A\" name=\"111111착오입금\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-18\"/><MENU id=\"MRT_PDA_010001\" uri=\"/MRT_PDA_010001\" use=\"A\" name=\"111111POS일일결산\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-19\"/><MENU id=\"MRT_CDD_010001\" uri=\"/MRT_CDD_010001\" use=\"A\" name=\"111111카드사매입\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-20\"/><MENU id=\"MRT_DLD_010001\" uri=\"/MRT_DLD_010001\" use=\"A\" name=\"111111입금일매입\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-21\"/><MENU id=\"MRT_RND_010001\" uri=\"/MRT_RND_010001\" use=\"A\" name=\"111111반송/미매입\" unique-id=\"1550023353886-ZNGSPJOAVSMLQODA-22\"/></MENU></tree></root>");

	  JXParser.fixedBy(jxp1, jxp2,"unique-id",new String[0]);
	  
	  System.out.println(jxp1.toString(null));
  }
}
