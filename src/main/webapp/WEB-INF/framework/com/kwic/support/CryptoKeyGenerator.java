...
public class CryptoKeyGenerator {
	...
	public static void main(String[] args) throws Exception{
		String key	= null;
		for(int i=0;i<100;i++){
			key	= CryptoKeyGenerator.getRandomKey(16,new int[]{CryptoKeyGenerator.KEY_TYPE_ENG_CAPITAL});
...
//		String key = "ABCDEFGHIJKLMNOPQRSTUVWXYZ123456";
		...
		encodeText	= AES.encode(plainText, key,AES.TYPE_256,"UTF-8",AES.MODE_CBC);
		System.out.println("aes 256 UTF-8 CBC Padding : "+encodeText);
		
		decodeText	= AES.decode(encodeText, key,AES.TYPE_256,"UTF-8",AES.MODE_CBC);
